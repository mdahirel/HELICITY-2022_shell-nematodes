...
# S3 : intensity (ish, number of nematodes in shells containing nematodes)
...
modx <- glm(cbind(N_nema,N-N_nema)~log(POP1000,10),data=data,family=binomial)
